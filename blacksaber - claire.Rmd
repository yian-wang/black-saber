...
salary <- lmer(salary ~ (1|employee_id) + leadership_for_level + productivity + gender, data = promotions) #employee IDs are not independent since this data set is over years so random effect on employee id? 
```
